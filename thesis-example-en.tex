...
\usepackage[group-minimum-digits=4,per-mode=fraction]{siunitx}
\sisetup{
    mode = match,             % Match the font of the surrounding text
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1. Stop subcaption from adding its own parens (to avoid double parens like ((a)))
\usepackage[labelformat=simple]{subcaption}

% 2. Bake the parens into the counter itself so \cref and \ref see them
...
\dateofexamination{1\textsuperscript{st} August, 2026}
